...
// SummarizeMessages compresses messages into a summary using a small model.
func SummarizeMessages(ctx context.Context, router *provider.Router, messages []fantasy.Message) (string, error) {
